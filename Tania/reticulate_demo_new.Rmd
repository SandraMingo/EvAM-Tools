---
title: "Reticulate_demo"
output: html_document
date: "2025-01-05"
---

```{r}
# Instalar mhn en el contenedor
...
## Cargar los datos tanto en R como Python y los inspeccionamos en este último
...
#Para acceder a los resultados desde R
result <- py$result
print(result)
```
## Creamos los objetos de la clase oMHNOptimizer y cMHNOptimizer del módulo optimizer
## Elegimos las penalizaciones de cada modelo
...
## Una vez calculada la lambda optima para cada modelo pasamos al entrenamiento
...
## Visualizamos la matriz log-Theta de cada modelo
...
## Simulación de datos artificiales a partir del modelo

## Calidad del ajuste del cMHN y oMHN 
...
```
## Prueba de Fisher para comprobar si se han recreado los patrones de co-ocurrencia en los datos de entrada
```{r}
...
## Predecir el siguiente evento dado un estado concreto
